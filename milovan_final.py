...
class Truck(Car,Motorcycle):
    ...
    truck_registration = TRUCK + (number_of_trailer - 1) * TRAILER
    FINAL_AMOUNT = Car.car_registration + Motorcycle.motor_registration + truck_registration

    print("VEHICLE3:")
    print("Truck:", truck_model)
    print("Engine size:", engine_size)
    print("Horse power:", truck_horse_power)
    print("Engine type:", truck_engine_type)
